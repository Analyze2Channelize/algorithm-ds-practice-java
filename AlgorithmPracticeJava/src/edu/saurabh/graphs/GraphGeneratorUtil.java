...
public class GraphGeneratorUtil {
     ...
     */
    public static AdjacencyListGraph simple(int V, int E) {
     ...
     */
    public static AdjacencyListGraph simple(int V, double p) {
        if (p < 0.0 || p > 1.0)
     ...
     */
    public static AdjacencyListGraph complete(int V) {
        return simple(V, 1.0);
    }
     ...
     * @throws IllegalArgumentException if probability is not between 0 and 1
     */
    public static AdjacencyListGraph completeBipartite(int V1, int V2) {
     ...
     */
    public static AdjacencyListGraph bipartite(int V1, int V2, int E) {
        if (E > (long) V1*V2) throw new IllegalArgumentException("Too many edges");
        if (E < 0)            throw new IllegalArgumentException("Too few edges");
        AdjacencyListGraph G = new AdjacencyListGraph(V1 + V2);
     ...
     * @throws IllegalArgumentException if probability is not between 0 and 1
     */
    public static AdjacencyListGraph bipartite(int V1, int V2, double p) {
        if (p < 0.0 || p > 1.0)
            throw new IllegalArgumentException("Probability must be between 0 and 1");
        int[] vertices = new int[V1 + V2];
        for (int i = 0; i < V1 + V2; i++)
     ...
     */
    public static AdjacencyListGraph path(int V) {
        AdjacencyListGraph G = new AdjacencyListGraph(V);
     ...
     */
    public static AdjacencyListGraph binaryTree(int V) {
        AdjacencyListGraph G = new AdjacencyListGraph(V);
        int[] vertices = new int[V];
        for (int i = 0; i < V; i++)
            vertices[i] = i;
     ...
     */
    public static AdjacencyListGraph cycle(int V) {
        AdjacencyListGraph G = new AdjacencyListGraph(V);
        int[] vertices = new int[V];
        for (int i = 0; i < V; i++)
            vertices[i] = i;
     ...
     */
    public static AdjacencyListGraph eulerianCycle(int V, int E) {
        if (E <= 0)
     ...
     * @throws IllegalArgumentException if either {@code V <= 0} or {@code E < 0}
     */
    public static AdjacencyListGraph eulerianPath(int V, int E) {
        if (E < 0)
     ...
     */
    public static AdjacencyListGraph wheel(int V) {
     ...
     *     every other vertex
     */
    public static AdjacencyListGraph star(int V) {
     ...
     */
    public static AdjacencyListGraph regular(int V, int k) {
     ...
     */
    public static AdjacencyListGraph tree(int V) {
        AdjacencyListGraph G = new AdjacencyListGraph(V);
