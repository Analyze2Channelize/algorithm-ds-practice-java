...
public class DigraphGeneratorUtil {
     ...
     */
    public static AdjacencyListDigraph simple(int V, int E) {
        if (E > (long) V*(V-1)) throw new IllegalArgumentException("Too many edges");
        if (E < 0)              throw new IllegalArgumentException("Too few edges");
        AdjacencyListDigraph G = new AdjacencyListDigraph(V);
   ...
   /**
     ...
     */
    public static AdjacencyListDigraph simple(int V, double p) {
        if (p < 0.0 || p > 1.0)
     ...
     */
    public static AdjacencyListDigraph complete(int V) {
     ...
     */
    public static AdjacencyListDigraph dag(int V, int E) {
     ...
     */
    public static AdjacencyListDigraph tournament(int V) {
        AdjacencyListDigraph G = new AdjacencyListDigraph(V);
        for (int v = 0; v < G.V(); v++) {
     ...
     */
    public static AdjacencyListDigraph rootedInDAG(int V, int E) {
        if (E > (long) V*(V-1) / 2) throw new IllegalArgumentException("Too many edges");
     ...
     */
    public static AdjacencyListDigraph rootedOutDAG(int V, int E) {
        if (E > (long) V*(V-1) / 2) throw new IllegalArgumentException("Too many edges");
        if (E < V-1)                throw new IllegalArgumentException("Too few edges");
        AdjacencyListDigraph G = new AdjacencyListDigraph(V);
        SET<Edge> set = new SET<Edge>();
     ...
     */
    public static AdjacencyListDigraph rootedInTree(int V) {
     ...
     */
    public static AdjacencyListDigraph rootedOutTree(int V) {
     ...
     */
    public static AdjacencyListDigraph path(int V) {
        AdjacencyListDigraph G = new AdjacencyListDigraph(V);
        int[] vertices = new int[V];
        for (int i = 0; i < V; i++)
            vertices[i] = i;
     ...
     */
    public static AdjacencyListDigraph binaryTree(int V) {
        AdjacencyListDigraph G = new AdjacencyListDigraph(V);
        int[] vertices = new int[V];
        for (int i = 0; i < V; i++)
            vertices[i] = i;
     ...
     */
    public static AdjacencyListDigraph cycle(int V) {
        AdjacencyListDigraph G = new AdjacencyListDigraph(V);
        int[] vertices = new int[V];
        for (int i = 0; i < V; i++)
            vertices[i] = i;
     ...
     */
    public static AdjacencyListDigraph eulerianCycle(int V, int E) {
        if (E <= 0)
     ...
     * @throws IllegalArgumentException if either {@code V <= 0} or {@code E < 0}
     */
    public static AdjacencyListDigraph eulerianPath(int V, int E) {
        if (E < 0)
   ...
   /**
     ...
     */
    public static AdjacencyListDigraph strong(int V, int E, int c) {
        if (c >= V || c <= 0)
